...
class MygroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mygroup" do
    assert_difference('Mygroup.count') do
      post mygroups_url, params: { mygroup: { name: @mygroup.name, user_id: @mygroup.user_id } }
    end
  ...
  test "should update mygroup" do
    patch mygroup_url(@mygroup), params: { mygroup: { name: @mygroup.name, user_id: @mygroup.user_id } }
